...
while(<>)
{
    if(m/^\d/)
    {
        ...
        # "Miesto" je předložka v 2.21 resp. 2.22, všude jinde je to podstatné jméno.
              ...
              $f[1] =~ m/^(břiem|břiš|diet|dietek|dietky|d(?:ó|uo)stojenstv|hniezd|hoř|jm|jmen|kniež|ledv|let|měst|miest|násil|neb|nebes|oc|oslíč|písemc|práv|rob|robátk|rúch|sěn|siem|slovc|srde?c|trn|tržišč|ust|vajc|zábradl)(o|e|é|ě|ie|a|i|u|ú|í|em|[eě]t[ei]|ata?|atóm|atuom|i?ech|ách|ích|aty)?$/i && $f[1] !~ m/^(diet[ei]|hniezdie|hoří?|hořěti|jm[eiu]?|jmie|letě|letie|letí|násil|neb[ou]?|nebiech|nebích|ocí)$/i)
        {
            my $lform = lc($f[1]);
            my %ma =
            (
