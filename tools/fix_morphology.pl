    ...
    if(m/^\d/)
    {
        ...
        if($f[1] =~ m/^(ne)?(anděl|anjel|apoštol|běs|brat[rř]|bu?o[hž]|býc|člověk|črv|dělní[kc]|diábe?l|dlužní[kc]|duch|duchovní[kcč]|had|hospodin|hřiešní[kc]|kacieř|kokot|kopáč|koze?lc?|krajěn|licoměrník|mládenečk|mistr|mudrá[kc]|muž|otc|pán|panoš|panošic|pe?s|pohan|pop|proro[kc]|přietel|rybář|rytieř|sath?an(?:as)?|sl[uú]h|starost|súdc|svědk|syn|šielene?[cč]|tetrarch|tovařiš|učedlní[kc]|učenní[kc]|velblúd|vodič|vrabc|ženc|žid)(a|e|ě|i|u|ovi|i?em|ú|oma|ie|ové|ěvé|é|óv|uov|í|ám|óm|uom|y|ami|ěmi)?$/i && $f[1] !~ m/^(bu?oží|bu?ožiem?|hospodinóv|popové)$/i)
        {
            ...
            (
                ...
                'anjelé'      => ['anděl',     'anděl',     [['Plur', 'P', 'Nom', '1']]],
                ...
                'běsa'        => ['běs',       'běs',       [['Sing', 'S', 'Gen', '2']]],
                'běsóv'       => ['běs',       'běs',       [['Plur', 'P', 'Gen', '2']]],
                'běsové'      => ['běs',       'běs',       [['Plur', 'P', 'Nom', '1']]],
                'běsy'        => ['běs',       'běs',       [['Plur', 'P', 'Acc', '4']]],
                ...
                'hada'         => ['had',        'had',        [['Sing', 'S', 'Gen', '2']]],
                'hadi'         => ['had',        'had',        [['Plur', 'P', 'Nom', '1']]],
                'hadové'       => ['had',        'had',        [['Plur', 'P', 'Nom', '1']]],
                ...
                'hospodinu'    => ['hospodin',   'hospodin',   [['Sing', 'S', 'Dat', '3']]],
                ...
                'hřiešníky'    => ['hříšník',    'hřiešník',   [['Plur', 'P', 'Ins', '7']]],
                'kacieři'      => ['kacíř',      'kacieř',     [['Plur', 'P', 'Nom', '1']]],
                'kacieřóv'     => ['kacíř',      'kacieř',     [['Plur', 'P', 'Gen', '2']]],
                'kopáči'       => ['kopáč',      'kopáč',      [['Plur', 'P', 'Nom', '1'], ['Plur', 'P', 'Ins', '7']]],
                'kopáčiem'     => ['kopáč',      'kopáč',      [['Plur', 'P', 'Dat', '3']]],
                ...
                'pohané'      => ['pohan',    'pohan',      [['Plur', 'P', 'Nom', '1']]],
                'pohanóm'     => ['pohan',    'pohan',      [['Plur', 'P', 'Dat', '3']]],
                'pohanové'    => ['pohan',    'pohan',      [['Plur', 'P', 'Nom', '1']]],
                'pohanuom'    => ['pohan',    'pohan',      [['Plur', 'P', 'Dat', '3']]],
                'popi'        => ['pop',      'pop',        [['Plur', 'P', 'Nom', '1']]],
                'popóm'       => ['pop',      'pop',        [['Plur', 'P', 'Dat', '3']]],
                'proroci'     => ['prorok',   'prorok',   [['Plur', 'P', 'Nom', '1']]],
                'prorok'      => ['prorok',   'prorok',   [['Sing', 'S', 'Nom', '1']]],
                'proroka'     => ['prorok',   'prorok',   [['Sing', 'S', 'Acc', '4'], ['Sing', 'S', 'Gen', '2']]],
                'prorokem'    => ['prorok',   'prorok',   [['Sing', 'S', 'Ins', '7']]],
                'prorokóm'    => ['prorok',   'prorok',   [['Plur', 'P', 'Dat', '3']]],
                'prorokóv'    => ['prorok',   'prorok',   [['Plur', 'P', 'Gen', '2']]],
                'proroky'     => ['prorok',   'prorok',   [['Plur', 'P', 'Acc', '4']]],
                'přietel'     => ['přítel',   'přietel',  [['Sing', 'S', 'Nom', '1']]],
                'přietele'    => ['přítel',   'přietel',  [['Sing', 'S', 'Acc', '4']]],
                'přietelé'    => ['přítel',   'přietel',  [['Plur', 'P', 'Nom', '1']]],
                'přieteli'    => ['přítel',   'přietel',  [['Sing', 'S', 'Voc', '5']]],
                'psi'         => ['pes',      'pes',      [['Plur', 'P', 'Nom', '1']]],
                'psóm'        => ['pes',      'pes',      [['Plur', 'P', 'Dat', '3']]],
                'psuom'       => ['pes',      'pes',      [['Plur', 'P', 'Dat', '3']]],
                'rybářě'      => ['rybář',    'rybář',    [['Dual', 'D', 'Nom', '1', 'MATT_4\\.18'], ['Dual', 'D', 'Acc', '4'], ['Plur', 'P', 'Acc', '4']]], # ve 4.19 je to akuzativ, v Drážďanské duál a v Olomoucké plurál, což tady neumíme rozetnout (umíme se zeptat na číslo verše, ale ne na Dr. vs. Ol.)
                'rybáři'      => ['rybář',    'rybář',    [['Plur', 'P', 'Nom', '1']]],
                'rytieřě'     => ['rytíř',    'rytieř',   [['Plur', 'P', 'Acc', '4']]],
                'rytieři'     => ['rytíř',    'rytieř',   [['Plur', 'P', 'Nom', '1']]],
                'rytieřiem'   => ['rytíř',    'rytieř',   [['Plur', 'P', 'Dat', '3']]],
                'rytieřóm'    => ['rytíř',    'rytieř',   [['Plur', 'P', 'Dat', '3']]],
                'satan'       => ['satan',    'satan',    [['Sing', 'S', 'Nom', '1']]],
                'satana'      => ['satan',    'satan',    [['Sing', 'S', 'Acc', '4']]],
                ...
                'sluhy'       => ['sluha',    'sluha',    [['Plur', 'P', 'Acc', '4']]],
                'starost'     => ['starosta', 'starosta', [['Plur', 'P', 'Gen', '2']]],
                'starostě'    => ['starosta', 'starosta', [['Sing', 'S', 'Dat', '3']]],
                'starostám'   => ['starosta', 'starosta', [['Plur', 'P', 'Dat', '3']]],
                'starostami'  => ['starosta', 'starosta', [['Plur', 'P', 'Ins', '7']]],
                'starosty'    => ['starosta', 'starosta', [['Plur', 'P', 'Nom', '1'], ['Plur', 'P', 'Acc', '4']]],
                'súdcě'       => ['soudce',   'súdcě',    [['Sing', 'S', 'Nom', '1'], ['Plur', 'P', 'Nom', '1', 'MATT_12\\.27']]],
                'súdci'       => ['soudce',   'súdcě',    [['Sing', 'S', 'Dat', '3']]],
                'svědkóv'     => ['svědek',   'svědek',   [['Plur', 'P', 'Gen', '2']]],
                'svědkú'      => ['svědek',   'svědek',   [['Dual', 'D', 'Gen', '2']]], # v ustech dvú svědkú 18.16
                'svědky'      => ['svědek',   'svědek',   [['Dual', 'D', 'Nom', '1']]], # dva křivá svědky 26.61
                'syn'         => ['syn',      'syn',      [['Sing', 'S', 'Nom', '1']]],
                'syna'        => ['syn',      'syn',      [['Sing', 'S', 'Acc', '4'], ['Sing', 'S', 'Gen', '2']]],
                'synem'       => ['syn',      'syn',      [['Sing', 'S', 'Ins', '7']]],
                'synóm'       => ['syn',      'syn',      [['Plur', 'P', 'Dat', '3']]],
                'synóv'       => ['syn',      'syn',      [['Plur', 'P', 'Gen', '2']]],
                'synové'      => ['syn',      'syn',      [['Plur', 'P', 'Nom', '1']]],
                'synu'        => ['syn',      'syn',      [['Sing', 'S', 'Dat', '3'], ['Sing', 'S', 'Voc', '5']]],
                'synuov'      => ['syn',      'syn',      [['Plur', 'P', 'Gen', '2']]],
                'syny'        => ['syn',      'syn',      [['Plur', 'P', 'Acc', '4'], ['Plur', 'P', 'Ins', '7'], ['Dual', 'D', 'Acc', '4', 'MATT_(21\\.28|26\\.37)']]],
                ...
                'velblúda'    => ['velbloud', 'velblúd',  [['Sing', 'S', 'Gen', '2']]],
                'velblúdovi'  => ['velbloud', 'velblúd',  [['Sing', 'S', 'Dat', '3']]],
                ...
                'zjěvníci'    => ['zjevník',  'zjěvník',  [['Plur', 'P', 'Nom', '1']]],
                'zjěvník'     => ['zjevník',  'zjěvník',  [['Sing', 'S', 'Nom', '1']]],
                'zjěvníkóv'   => ['zjevník',  'zjěvník',  [['Plur', 'P', 'Gen', '2']]],
                'ženci'       => ['žnec',     'žnec',     [['Plur', 'P', 'Nom', '1']]],
                'ženciem'     => ['žnec',     'žnec',     [['Plur', 'P', 'Dat', '3']]],
                'žencóm'      => ['žnec',     'žnec',     [['Plur', 'P', 'Dat', '3']]],
                'židie'       => ['žid',      'žid',      [['Plur', 'P', 'Nom', '1']]],
                'židóv'       => ['žid',      'žid',      [['Plur', 'P', 'Gen', '2']]],
                'židy'        => ['žid',      'žid',      [['Plur', 'P', 'Acc', '4'], ['Plur', 'P', 'Ins', '7']]]
            );
        ...
        elsif($f[1] =~ m/^(Archelaus|Bar[nr]abáš|Daniel|H?eliáš|H?erod(?:es)?|Izaiáš|Jezukrist(?:us)?|Ježíš|Jozef|Mojžieš|Ozěp|Petr|Pilát|Šalomún|Zebedáš|Zebede)(a|e|ě|u|i|ovi|e|em)?$/i && !($f[1] =~ m/ovi$/i && $f[3] eq 'ADJ'))
        {
            ...
            (
                ...
                'barnabášě'    => ['Barnabáš',    'Barnabáš',    [['Sing', 'S', 'Acc', '4']]],
                'barrabáš'     => ['Barnabáš',    'Barnabáš',    [['Sing', 'S', 'Nom', '1']]],
                'barrabášě'    => ['Barnabáš',    'Barnabáš',    [['Sing', 'S', 'Acc', '4']]],
                'daniel'       => ['Daniel',      'Daniel',      [['Sing', 'S', 'Nom', '1']]],
                'daniele'      => ['Daniel',      'Daniel',      [['Sing', 'S', 'Gen', '2']]],
                'eliáš'        => ['Eliáš',       'Eliáš',       [['Sing', 'S', 'Nom', '1']]],
                'eliášovi'     => ['Eliáš',       'Eliáš',       [['Sing', 'S', 'Dat', '3']]],
                'eliáše'       => ['Eliáš',       'Eliáš',       [['Sing', 'S', 'Acc', '4']]],
                'eliášě'       => ['Eliáš',       'Eliáš',       [['Sing', 'S', 'Acc', '4']]],
                'erodes'       => ['Herodes',     'Herodes',     [['Sing', 'S', 'Nom', '1']]],
                'erodovi'      => ['Herodes',     'Herodes',     [['Sing', 'S', 'Dat', '3']]],
                'heliáš'       => ['Eliáš',       'Eliáš',       [['Sing', 'S', 'Nom', '1']]],
                'heliášovi'    => ['Eliáš',       'Eliáš',       [['Sing', 'S', 'Dat', '3']]],
                'heliáše'      => ['Eliáš',       'Eliáš',       [['Sing', 'S', 'Acc', '4']]],
                'heliášě'      => ['Eliáš',       'Eliáš',       [['Sing', 'S', 'Acc', '4']]],
                ...
                'izaiáše'      => ['Izaiáš',      'Izaiáš',      [['Sing', 'S', 'Gen', '2'], ['Sing', 'S', 'Acc', '4']]],
                'izaiášě'      => ['Izaiáš',      'Izaiáš',      [['Sing', 'S', 'Gen', '2'], ['Sing', 'S', 'Acc', '4']]],
                ...
                'ježíše'       => ['Ježíš',       'Ježíš',       [['Sing', 'S', 'Gen', '2'], ['Sing', 'S', 'Acc', '4']]],
                'ježíšě'       => ['Ježíš',       'Ježíš',       [['Sing', 'S', 'Gen', '2'], ['Sing', 'S', 'Acc', '4']]],
                'ježíši'       => ['Ježíš',       'Ježíš',       [['Sing', 'S', 'Dat', '3'], ['Sing', 'S', 'Voc', '5']]],
                ...
                'mojžiešovi'   => ['Mojžíš',      'Mojžieš',     [['Sing', 'S', 'Dat', '3']]],
        ...
        elsif($f[1] =~ m/^(balšám|buochenc|čas|čin|déšč|div|dn|dóm|du?om|fík|hrob|hřie(ch|š)|chleb|kořen|ku?oš|kút|národ|neduh|okrajk|otrusk|pas|peniez|pláč|plamen|plášč|podhrdlk|podolk|poklad|příklad|rov|sbuor|skutk|sn|stien|stol|súd|ščěvík|tisíc|úd|u?oheň|u?ohn|u?ostatk|uzlíc|užitk|větr|vlas|zárodc|zástup|zbytk|zub)(a|e|ě|i|u|ové|óv|uov|iev|í|óm|uom|y|ách|iech)?$/i && $f[1] !~ m/^(dn[ay]|činí|fíkové|pas[ae]|pláče|súdí)$/i)
        {
            my $lform = lc($f[1]);
            my %ma =
            (
                ...
                'dne'         => ['den',       'den',     [['Sing', 'S', 'Gen', '2']]],
                'dni'         => ['den',       'den',     [['Sing', 'S', 'Loc', '6'], ['Plur', 'P', 'Acc', '4', 'MATT_(12\\.40|15\\.32|28\\.20)']]], # Plur Acc: 12.40 15.32 28.20; Sing Loc: 6.34 13.1 24.36
                'dní'         => ['den',       'den',     [['Plur', 'P', 'Gen', '2']]],
                'dnóv'        => ['den',       'den',     [['Plur', 'P', 'Gen', '2']]],
                'dnové'       => ['den',       'den',     [['Plur', 'P', 'Nom', '1']]],
                'dnuov'       => ['den',       'den',     [['Plur', 'P', 'Gen', '2']]],
                'dóm'         => ['dům',       'dóm',     [['Sing', 'S', 'Acc', '4'], ['Sing', 'S', 'Nom', '1']]],
                'domiech'     => ['dům',       'dóm',     [['Plur', 'P', 'Loc', '6']]],
                'domu'        => ['dům',       'dóm',     [['Sing', 'S', 'Gen', '2'], ['Sing', 'S', 'Loc', '6']]],
                'domy'        => ['dům',       'dóm',     [['Plur', 'P', 'Acc', '4']]],
                'duom'        => ['dům',       'dóm',     [['Sing', 'S', 'Acc', '4'], ['Sing', 'S', 'Nom', '1']]],
                'duomu'       => ['dům',       'dóm',     [['Sing', 'S', 'Loc', '6']]],
                'fíky'        => ['fík',       'fík',     [['Plur', 'P', 'Acc', '4']]],
                ...
                'národu'      => ['národ',     'národ',   [['Sing', 'S', 'Dat', '3']]],
                ...
                'otruskóv'    => ['otrusek',   'otrusek', [['Plur', 'P', 'Gen', '2']]], # zbytek (co se utrousí)
                ...
                'podolka'     => ['podolek',   'podolek', [['Sing', 'S', 'Gen', '2']]],
                'podolky'     => ['podolek',   'podolek', [['Plur', 'P', 'Acc', '4']]],
                ...
                'rovy'        => ['rov',       'rov',     [['Plur', 'P', 'Acc', '4']]],
                'sbuoru'      => ['sbor',      'sbuor',   [['Sing', 'S', 'Gen', '2']]],
                'skutkóv'     => ['skutek',    'skutek',  [['Plur', 'P', 'Gen', '2']]],
                'skutku'      => ['skutek',    'skutek',  [['Sing', 'S', 'Gen', '2']]],
                'skutky'      => ['skutek',    'skutek',  [['Plur', 'P', 'Acc', '4']]],
                'sna'         => ['sen',       'sen',     [['Sing', 'S', 'Gen', '2']]],
                'snách'       => ['sen',       'sen',     [['Plur', 'P', 'Loc', '6']]],
                'sně'         => ['sen',       'sen',     [['Sing', 'S', 'Loc', '6']]],
                'stieni'      => ['stín',      'stien',   [['Sing', 'S', 'Loc', '6']]],
                'stola'       => ['stůl',      'stól',    [['Sing', 'S', 'Gen', '2']]],
                'stolem'      => ['stůl',      'stól',    [['Sing', 'S', 'Ins', '7']]],
                'stolóv'      => ['stůl',      'stól',    [['Plur', 'P', 'Gen', '2']]],
                'stoly'       => ['stůl',      'stól',    [['Plur', 'P', 'Acc', '4']]],
                ...
                'užitka'      => ['užitek',    'užitek',  [['Sing', 'S', 'Gen', '2']]],
                'užitky'      => ['užitek',    'užitek',  [['Plur', 'P', 'Acc', '4'], ['Plur', 'P', 'Ins', '7']]],
                'větróm'      => ['vítr',      'vietr',   [['Plur', 'P', 'Dat', '3']]],
                'větróv'      => ['vítr',      'vietr',   [['Plur', 'P', 'Gen', '2']]],
                'větrové'     => ['vítr',      'vietr',   [['Plur', 'P', 'Nom', '1']]],
                'vlasa'       => ['vlas',      'vlas',    [['Sing', 'S', 'Gen', '2']]],
                'vlasi'       => ['vlas',      'vlas',    [['Plur', 'P', 'Nom', '1']]],
                'vlasy'       => ['vlas',      'vlas',    [['Plur', 'P', 'Nom', '1']]],
                'zárodci'     => ['zárodek',   'zárodek', [['Plur', 'P', 'Voc', '5']]],
        ...
        elsif(!($f[1] =~ m/^hoře$/i && get_ref($f[9]) !~ m/^MATT_24\.3$/) &&
              $f[1] =~ m/^(buožnic|cěst|dci|dn|duš|hu?o[rř]|libř|lichv|mátě|m[aá]teř|matk|měřic|mís|modlitv|n[oó][hz]|potop|přísah|púš[čtť]|rez|ruc|siet|sól|stred|suol|světedlnic|škuol|trúb|ulic|u?ovc|vesnic|vier|vinn|vuod)(e|ě|i|í|y|u|ú|iem|iech|ách|ami)?$/i)
        {
            ...
            (
                ...
                'nohy'        => ['noha',     'noha',     [['Plur', 'P', 'Acc', '4']]],
                'nozě'        => ['noha',     'noha',     [['Dual', 'D', 'Acc', '4']]],
                'ovcě'        => ['ovce',     'ovcě',     [['Sing', 'S', 'Nom', '1'], ['Plur', 'P', 'Nom', '1'], ['Plur', 'P', 'Acc', '4']]],
                'ovci'        => ['ovce',     'ovcě',     [['Sing', 'S', 'Acc', '4']]],
                ...
                'přísahy'     => ['přísaha',  'přísaha',  [['Sing', 'S', 'Gen', '2']]],
                'púščě'       => ['poušť',    'púščě',    [['Sing', 'S', 'Nom', '1']]],
                'púšči'       => ['poušť',    'púščě',    [['Sing', 'S', 'Acc', '4'], ['Sing', 'S', 'Loc', '6']]],
                'púšť'        => ['poušť',    'púščě',    [['Sing', 'S', 'Acc', '4']]],
                'púšti'       => ['poušť',    'púščě',    [['Sing', 'S', 'Acc', '4'], ['Sing', 'S', 'Loc', '6']]],
                'rez'         => ['rez',      'rez',      [['Sing', 'S', 'Nom', '1']]],
                'rucě'        => ['ruka',     'ruka',     [['Dual', 'D', 'Acc', '4'], ['Plur', 'P', 'Acc', '4', 'MATT_(4\\.6|26\\.45|26\\.50)'], ['Sing', 'S', 'Loc', '6', 'MATT_(3\\.12|17\\.21)']]],
        ...
        # "Miesto" je předložka v 2.21 resp. 2.22, všude jinde je to podstatné jméno.
              ...
              $f[1] =~ m/^(břiem|břiš|diet|dietek|dietky|d(?:ó|uo)stojenstv|hniezd|hoř|jm|jmen|kniež|ledv|let|líc|měst|miest|násil|neb|nebes|oc|oslíč|písemc|práv|rob|robátk|rúch|sěn|siem|slovc|srde?c|trn|tržišč|ust|vajc|zábradl)(o|e|é|ě|ie|a|i|u|ú|í|em|[eě]t[ei]|ata?|atóm|atuom|i?ech|ách|ích|aty)?$/i && $f[1] !~ m/^(diete|jme|nebo?)$/i)
        {
            my $lform = lc($f[1]);
            my %ma =
            (
                ...
                'nebe'        => ['nebe',     'nebě',     [['Sing', 'S', 'Nom', '1'], ['Sing', 'S', 'Gen', '2']]],
                'nebě'        => ['nebe',     'nebě',     [['Sing', 'S', 'Nom', '1'], ['Sing', 'S', 'Gen', '2']]],
                'nebes'       => ['nebe',     'nebě',     [['Plur', 'P', 'Gen', '2']]],
                'nebesa'      => ['nebe',     'nebě',     [['Plur', 'P', 'Nom', '1'], ['Plur', 'P', 'Acc', '4']]],
                'nebesiech'   => ['nebe',     'nebě',     [['Plur', 'P', 'Loc', '6']]],
                'nebi'        => ['nebe',     'nebě',     [['Sing', 'S', 'Loc', '6'], ['Sing', 'S', 'Dat', '3']]],
                ...
                'právo'       => ['právo',    'právo',    [['Plur', 'P', 'Nom', '1']]],
        ...
        elsif($f[1] =~ m/^(dobreh|d(?:ó|uo)stojn|jin|lesk|lidsk|nebe(?:sk|št)|neptalimov(?:sk)?|ohněv|popov|propuščen|smrtedln|velik|vysok|židov(?:sk|št)?)(ý|á|é|ého|ém|ým|ú|éj|ie|í|ých|ými)$/i)
        {
            ...
            (
                ...
                'leská'      => ['lesní',    'leský',     [['Fem',  'F', 'Sing', 'S', 'Nom', '1']]],
                'lidská'     => ['lidský',   'lidský',    [['Neut', 'N', 'Plur', 'P', 'Acc', '4']]],
                'lidské'     => ['lidský',   'lidský',    [['Fem',  'F', 'Sing', 'S', 'Loc', '6'], ['Neut', 'N', 'Sing', 'S', 'Nom', '1'], ['Neut', 'N', 'Sing', 'S', 'Acc', '4'], ['Anim', 'M', 'Plur', 'P', 'Acc', '4'], ['Anim', 'M', 'Dual', 'D', 'Acc', '4', 'MATT_4\\.19']]],
                'lidskéj'    => ['lidský',   'lidský',    [['Fem',  'F', 'Sing', 'S', 'Loc', '6']]],
                'lidskú'     => ['lidský',   'lidský',    [['Fem',  'F', 'Sing', 'S', 'Acc', '4']]],
                'nebeské'    => ['nebeský',  'nebeský',   [['Neut', 'N', 'Sing', 'S', 'Nom', '1'], ['Neut', 'N', 'Sing', 'S', 'Acc', '4'], ['Fem',  'F', 'Plur', 'P', 'Nom', '1']]],
                'nebeského'  => ['nebeský',  'nebeský',   [['Neut', 'N', 'Sing', 'S', 'Gen', '2']]],
                'nebeském'   => ['nebeský',  'nebeský',   [['Neut', 'N', 'Sing', 'S', 'Loc', '6']]],
                'nebeskú'    => ['nebeský',  'nebeský',   [['Fem',  'F', 'Sing', 'S', 'Acc', '4']]],
                'nebeský'    => ['nebeský',  'nebeský',   [['Anim', 'M', 'Sing', 'S', 'Nom', '1'], ['Anim', 'M', 'Sing', 'S', 'Voc', '5']]],
                'nebeských'  => ['nebeský',  'nebeský',   [['Inan', 'I', 'Plur', 'P', 'Gen', '2'], ['Inan', 'I', 'Plur', 'P', 'Loc', '6']]],
                'nebeští'    => ['nebeský',  'nebeský',   [['Anim', 'M', 'Plur', 'P', 'Nom', '1']]],
                ...
                'židovských' => ['židovský', 'židovský',  [['Anim', 'M', 'Plur', 'P', 'Gen', '2'], ['Inan', 'I', 'Plur', 'P', 'Gen', '2'], ['Fem',  'F', 'Plur', 'P', 'Gen', '2']]],
        ...
        elsif($f[1] =~ m/^(bližn|bu?ož|člověč|jěš(?:če|tě)(?:r|ři)č)(í|ieho|iemu|iem|ím|ie|iej|ích)$/i)
        {
            ...
            my %ma =
            (
                'bližnieho'    => ['bližní',   'bližní',    [['Anim', 'M', 'Sing', 'S', 'Acc', '4']]], # Tohle by možná mělo být substantivum, ale s adjektivním skloňováním, a na to se mi teď nechce zakládat samostatnou větev.
        ...
        elsif($f[1] =~ m/^(Abraham|Al(f|ph)e|Belzebub|David|Erod|Herodes|Izaiáš|Izák|Jakub|Jan|Ježíš|Jozef|Mojžieš|Ozěp|Petr|Šalomún|Zachař|Zebede(áš|us)?)(óv|ova|ově|ovo|ovu|ovú|ovy|ových)$/i)
        {
            ...
            (
                ...
                'davidóv'       => ['Davidův',    'Davidóv',    [['Anim', 'M', 'Sing', 'S', 'Voc', '5'], ['Anim', 'M', 'Sing', 'S', 'Nom', '1']]],
                'davidova'      => ['Davidův',    'Davidóv',    [['Inan', 'I', 'Sing', 'S', 'Gen', '2']]],
                'davidovu'      => ['Davidův',    'Davidóv',    [['Anim', 'M', 'Sing', 'S', 'Dat', '3']]],
                ...
                'ježíšova'      => ['Ježíšův',    'Ježíšóv',    [['Fem',  'F', 'Sing', 'S', 'Nom', '1'], ['Neut', 'N', 'Sing', 'S', 'Gen', '2', 'MATT_27\\.58']]],
                'ježíšovo'      => ['Ježíšův',    'Ježíšóv',    [['Neut', 'N', 'Sing', 'S', 'Acc', '4']]],
                'jozefova'      => ['Josefův',    'Jozefóv',    [['Fem',  'F', 'Sing', 'S', 'Nom', '1']]],
                'mojžiešově'    => ['Mojžíšův',   'Mojžiešóv',  [['Fem',  'F', 'Sing', 'S', 'Loc', '6']]],
                'ozěpova'       => ['Josefův',    'Ozěpóv',     [['Fem',  'F', 'Sing', 'S', 'Nom', '1']]],
                'petrova'       => ['Petrův',     'Petróv',     [['Inan', 'I', 'Sing', 'S', 'Gen', '2']]],
                'šalomúnovu'    => ['Šalamounův', 'Šalomúnóv',  [['Fem',  'F', 'Sing', 'S', 'Acc', '4']]],
