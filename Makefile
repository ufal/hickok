...
postprocess:
	...
	udapy read.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A1).conllu util.Eval node='node.misc = {}' ud.cs.MarkFeatsBugs write.TextModeTreesHtml files=data/annotated/13_19_stol/$(ANNBASE)_$(A1).bugs.html marked_only=1 layout=compact attributes=form,lemma,upos,xpos,feats,deprel,misc
	udapy read.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A2).conllu util.Eval node='node.misc = {}' ud.cs.MarkFeatsBugs write.TextModeTreesHtml files=data/annotated/13_19_stol/$(ANNBASE)_$(A2).bugs.html marked_only=1 layout=compact attributes=form,lemma,upos,xpos,feats,deprel,misc
