...
postprocess_def:
	...
	( perl ./tools/process_annotated_csv.pl --orig data/for_annotation/$(STOL)/$(ANNBASE).tsv --name1 DEF --ann1 data/annotated/$(STOL)/$(ANNBASE)_DEF.csv --name2 DEF --ann2 data/annotated/$(STOL)/$(ANNBASE)_DEF.csv > data/annotated/$(STOL)/$(ANNBASE)_DEF_DEF_diff.txt ) |& tee data/annotated/$(STOL)/$(ANNBASE)_DEF_DEF_postprocess.log
