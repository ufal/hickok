...
postprocess:
	...
	udapy read.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A1).conllu util.SplitSentence misc_name=SplitSentence ud.cs.AddMwt ud.FixRoot ud.FixAdvmodByUpos ud.FixMultiSubjects util.Eval node='if node.upos=="PUNCT": node.deprel="punct"' ud.FixLeaf ud.FixRightheaded deprels=conj,flat,fixed,appos,goeswith,list ud.FixPunct write.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A1).fixed.conllu
	udapy read.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A2).conllu util.SplitSentence misc_name=SplitSentence ud.cs.AddMwt ud.FixRoot ud.FixAdvmodByUpos ud.FixMultiSubjects util.Eval node='if node.upos=="PUNCT": node.deprel="punct"' ud.FixLeaf ud.FixRightheaded deprels=conj,flat,fixed,appos,goeswith,list ud.FixPunct write.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A2).fixed.conllu
