...
postprocess:
	...
	udapy read.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A1).conllu ud.FixAdvmodByUpos ud.FixMultiSubjects util.Eval node='if node.upos=="PUNCT": node.deprel="punct"' ud.FixPunct ud.FixLeaf write.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A1).fixed.conllu
	udapy read.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A2).conllu ud.FixAdvmodByUpos ud.FixMultiSubjects util.Eval node='if node.upos=="PUNCT": node.deprel="punct"' ud.FixPunct ud.FixLeaf write.Conllu files=data/annotated/13_19_stol/$(ANNBASE)_$(A2).fixed.conllu
	...
	validate.py --lang cs data/annotated/13_19_stol/$(ANNBASE)_$(A2).fixed.conllu |& tee data/annotated/13_19_stol/$(ANNBASE)_$(A2).validation.log
